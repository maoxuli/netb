...
public:
    ...
    StreamReader();
    StreamReader(ByteStream* buf);
    StreamReader(ByteStream& buf);  // buf can not be const, i.e. temporary variable
    ~StreamReader();

    StreamReader& Attach(ByteStream* buf);
    StreamReader& Attach(ByteStream& buf); // buf can not be const, i.e. temporary variable
