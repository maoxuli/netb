...
public:
    ...
    bool Bytes(size_t offset, void* p, size_t n);
    ...
    bool String(size_t offset, std::string& s);
    
    // Peek string 
    // that is n bytes length
    bool String(size_t offset, std::string& s, size_t n);

    // Peek string
    // to delimit character (e.g. '\0')
    bool String(size_t offset, std::string& s, const char delim);
